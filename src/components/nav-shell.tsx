    ...
    <StudentDrawerProvider>
      <div className="flex min-h-screen flex-col md:flex-row">
        ...
        <aside className="hidden w-64 shrink-0 flex-col border-r border-neutral-200/80 bg-white md:flex dark:border-neutral-800/80 dark:bg-neutral-900/60">
          ...
          <div className="relative border-t border-neutral-200/80 p-4 dark:border-neutral-800" ref={dropdownRef}>
            <button
              type="button"
              onClick={() => setDropdownOpen((prev) => !prev)}
              className="flex w-full items-center justify-between gap-3 rounded-xl bg-neutral-50 p-2.5 text-left transition-colors hover:bg-neutral-100 dark:bg-neutral-800/40 dark:hover:bg-neutral-800/80"
            >
              ...
              <ChevronDown className={`h-4 w-4 shrink-0 text-neutral-400 transition-transform duration-200 ${dropdownOpen ? "rotate-180" : ""}`} />
            </button>

            {/* Desktop Profile Dropdown Popover */}
            {dropdownOpen && (
              <div className="absolute bottom-full left-4 right-4 mb-2 z-50 rounded-xl border border-neutral-200/90 bg-white p-2 shadow-xl animate-in fade-in slide-in-from-bottom-2 dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <Link
                  ...
                  className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-xs font-semibold text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800"
                >
                ...
                <button
                  ...
                  disabled={loggingOut}
                  className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 disabled:opacity-50 dark:text-red-400 dark:hover:bg-red-950/40"
                >
